Ext.define('Infosys_web.controller.Facturaglosa', {
    ...
    grabarfacturaglosa: function() {
        ...
        var cuentacontable = viewIngresa.down('#cuentacontableId').getValue();
        var centrocosto = viewIngresa.down('#centrocostoId').getValue();
        
        var numpresu = viewIngresa.down('#numeropresupuestoId').getValue();
        var ocompras = viewIngresa.down('#ordendecompraId').getValue();
        
        var stItem = this.getFacturaglosaItemsStore();
        var stFactura = this.getFacturaStore(); 
        
        if(!cuentacontable){
            Ext.Msg.alert('Ingrese Cuenta Contable');
            return;   
        };

         
        if(!idcondventa){
            Ext.Msg.alert('Ingrese Condicion de Venta');
            return;   
        };
        ...
        if(!centrocosto){
            Ext.Msg.alert('Ingrese Centro de Costo');
            return;   
        };    
